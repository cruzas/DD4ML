...
def download_shakespeare():
    ...
    url = 'https://github.com/jcjohnson/torch-rnn/blob/master/data/tiny-shakespeare.txt'
...
def load_shakespeare(train_split=0.8, block_size=128, percentage=100.0):
    ...
    # Assumes a character-level tokenizer class
    tokenizer = CharTokenizer(data)
    dataset = ShakespeareDataset(
        data, tokenizer, block_size=block_size)  # Custom dataset class
