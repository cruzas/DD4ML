...
from src.models.resnet.base_resnet import BaseResNet
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, downsample=None):
        ...
        self.start = nn.Conv2d(in_channels, out_channels, kernel_size=3,
...
class SimpleResNet(BaseResNet):
    ...
    def __init__(self, config, block=BasicBlock, layers=[2, 2, 2, 2], num_classes=10):
        ...
        self.in_channels = 64
        self.start = nn.Conv2d(config.input_channels, 64, kernel_size=7,
