...
submit_job() {
    ...
    job_name="ts_t_${trial}_nw_${num_workers}_bls_${BLOCK_SIZE}_nl_${N_LAYER}_nh_${N_HEAD}_ne_${N_EMBD}_ns_${num_subdomains}_nr_${num_replicas_per_subdomain}_st_${num_stages}_bs_${batch_size}_dc_${DATA_CHUNKS_AMOUNT}_lr_${lr_str}_perc_${perc_str}_epochs_${NUM_EPOCHS}_parsgd"
